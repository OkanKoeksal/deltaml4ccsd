...
# BPBrBr / MP2 -> CCSD values
N_TOTAL = 5557
N_KNOWN = 972
N_TRAIN = 800

# Choose the accepted-paper SOAP random state if already known.
RANDOM_STATE = 37
...
# SOAP settings for B/P/Br systems
SOAP_SPECIES = ["B", "P", "Br"]
SOAP_R_CUT = 5.5
SOAP_N_MAX = 8
SOAP_L_MAX = 6
...
# Add MP2 as an extra scalar feature after SOAP
...
# Optuna trials used only if pretrained SOAP-SVR model is absent
SVR_TRIALS = 96
SVR_N_JOBS = -1
...
def get_or_build_soap_features(xyz_files, npy_path, n_processes):
    ...
    print("Computing SOAP features from processed xyz list...")

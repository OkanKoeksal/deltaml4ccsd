...
# Helpers
# =====================================================
def choose_existing_file(primary):
    if os.path.exists(primary):
        return primary
    raise FileNotFoundError("Neither file exists: {} nor {}".format(primary))
...
def main():
    ...
    features_file = choose_existing_file(FEATURES_FILE)
    xyz_list_file = choose_existing_file(XYZ_LIST_FILE)
    low_level_file = choose_existing_file(LOW_LEVEL_ENERGIES_FILE)
    ccsd_file = choose_existing_file(CCSD_ENERGIES_FILE)

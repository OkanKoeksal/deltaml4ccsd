...
PREDICTION_FILES = {
    "GB":  "results_clean/predicted_ccsd_from_mp2_gbr.txt",
    "GPR": "results_clean/predicted_ccsd_from_mp2_gpr.txt",
    "SVR": "results_clean/predicted_ccsd_from_mp2_svr.txt",
}
...
def collect_prediction_files():
    ...
    if not files:
        raise FileNotFoundError(
            "No prediction files found. Expected either results_clean/predicted_ccsd_from_mp2_*.txt "

#!/usr/bin/env python3
"""
Central wrapper for handcrafted-descriptor Delta-ML models.

Usage:
    PYTHONPATH=src python -m deltaml4ccsd.train_handcrafted \
...
def main():
    ...
    script_path = dataset_dir / "1_train_handcrafted_delta_ml_models.py"
    require_file(script_path)

    print("Running handcrafted workflow:")
    ...
    try:
        ...
        runpy.run_path("1_train_handcrafted_delta_ml_models.py", run_name="__main__")
    finally:
